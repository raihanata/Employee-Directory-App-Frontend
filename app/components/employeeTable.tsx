    ...
    return (
        <div>
            <div className="grid grid-cols-2 gap-20">
                ...
                <button
                    onClick={openModal}
                    className="bg-blue-800 text-white px-4 py-2 rounded hover:bg-blue-800 h-11"
                >
                    + Add Employee
                </button>
            </div>
                        ...
                        paginatedEmployees.map((emp: any) => (
                            <tr key={emp.id} className="hover:bg-gray-100">
                                <td className="border px-4 py-2">
                                    ...
                                    <Link href={`/employee/${emp.id}`} className="text-blue-800 hover:underline">
                                        {emp.name}
                                    </Link>
                                </td>
                ...
                <div className="flex justify-center gap-2 mt-4">
                    ...
                    {Array.from({ length: totalPages }, (_, i) => (
                        <button
                            ...
                            className={`px-3 py-1 border rounded ${currentPage === i + 1 ? "bg-blue-800 text-white" : ""}`}
                        >
                            {i + 1}
                        </button>
                    ))}
